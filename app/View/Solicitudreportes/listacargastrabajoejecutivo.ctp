...
<div class="solicitudreportes index">
	<legend><h2><?php echo __('Lista Cargas de Trabajo Ejecutivo'); ?></h2></legend>
	...
	<tr>
		...
		<td class="actions">
                    ...
                    echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $solicitudreporte['Solicitudreporte']['id'], 'listacargastrabajoejecutivo', '3'), null, __('Está seguro que desea eliminar el registro?'));
                    ?>                    
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Nueva Solicitud de Reporte'), array('action' => 'cargastrabajoejecutivo')); ?></li>
	</ul>
</div>
