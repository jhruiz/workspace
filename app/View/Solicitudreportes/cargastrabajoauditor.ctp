...
<?php echo $this->Form->create('Solicitudreporte',array('controller' => 'solicitudreportes','action'=>'generarReporteCargasAuditor')); ?>
    <fieldset>
        <legend><h3><br /><?php echo __('Generador de Reportes - Cargas de Trabajo Auditor'); ?></h3></legend>
        <br />
        <table width="100%">
            <tr>
                <td>
                    <div><?php echo $this->Form->input('usuario', array('label' => __('Usuario Auditor'), 'options' => $usuarioAuditor, 'empty' => __('Todos'))); ?></div>
                    <?php echo $this->Form->input('tiporeporte', array('type' => 'hidden', 'value' => '2'));?>
                </td>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Ver Solicitudes de Reporte'), array('action' => 'listacargastrabajoauditor', '2')); ?></li>				
	</ul>
</div>