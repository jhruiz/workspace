...
<?php echo $this->Form->create('Solicitudreporte'); ?>
	<fieldset>
		<legend><?php echo __('Edit Solicitudreporte'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Solicitudreporte.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Solicitudreporte.id'))); ?></li>
