...
<div class="usuarios index">
	...
	<tr>
		<td><?php echo h($usuario['Usuario']['nombre']); ?>&nbsp;</td>    
				...
				<td><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-eye fa-lg')), array('controller' => 'paquetes_usuarios', 'action' => 'listasolicitudes', $usuario['Usuario']['id']), array('escape' => false)) ?></td>
	</tr>
<?php endforeach; ?>
	</table>
