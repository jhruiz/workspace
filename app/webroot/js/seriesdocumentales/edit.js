...
var copyFirstIndiceTemplate = function () {
    ...
    if (value !== '0') {
        ...
        tpl.find('select')
                .attr('id', 'Indicespadredoc' + countIndices + 'IndicedocId')
                .attr('name', 'data[Indicespadredoc][' + countIndices + '][indicedoc_id]');
        tpl.find('input')
                .attr('id', 'Indicespadredoc' + countIndices + 'Obligatorio')
                .attr('name', 'data[Indicespadredoc][' + countIndices + '][obligatorio]');
